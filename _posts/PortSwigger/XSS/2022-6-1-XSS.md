...
<img src="/assets/img/portswigger/xss/4_1.png" style="zoom:80%;" />
...
- Repeat the process again but this time replace your input with the following payload to inject a JavaScript URL that calls alert:
  ...
  <img src="/assets/img/portswigger/xss/5_1.png" style="zoom:80%;" />
...
<img src="/assets/img/portswigger/xss/8_1.png" style="zoom:80%;" />
...
<img src="/assets/img/portswigger/xss/1_1.png" style="zoom:70%;" />
...
<img src="/assets/img/portswigger/xss/2_1.png" style="zoom:80%;" />
...
- When the attack is finished, review the results. Note that all payloads caused an HTTP 400 response, except for the `onresize` payload, which caused a 200 response.
  ...
  <img src="/assets/img/portswigger/xss/2_2.png" style="zoom:80%;" />
...
<img src="/assets/img/portswigger/xss/3_1.png" style="zoom:80%;" />
...
<img src="/assets/img/portswigger/xss/3_2.png" style="zoom:80%;" />
...
<img src="/assets/img/portswigger/xss/6_1.png" style="zoom:80%;" />
...
<img src="/assets/img/portswigger/xss/7_1.png" style="zoom:80%;" />
...
<img src="/assets/img/portswigger/xss/9_1.png" style="zoom:80%;" />
...
<img src="/assets/img/portswigger/xss/10_1.png" style="zoom:80%;" />
...
<img src="/assets/img/portswigger/xss/10_2.png" style="zoom:90%;" />
...
<img src="/assets/img/portswigger/xss/11_1.png" style="zoom:80%;" />
